...
Calendar.weekendDow = [FRIDAY, SATURDAY] // Weekend days
Calendar.fontFace = "Verdana" // Font face/family used for whole calendar
Calendar.pageBgColor = "#FFFFFF" // Page background color
Calendar.monthColor = "#0A246A" // Month, year text color
Calendar.monthFontWeight = "bold" // Font weight ("bold" | "normal")

Calendar.monthFontSize = "10pt" // Font size (i.e., "10pt" | "14px")
Calendar.navbarColor = "#ffffff" // Navigation bar text color
Calendar.navbarBgColor = "#94B3D0" // Background color
Calendar.navbarFontWeight = "bold" // Font weight ("bold" | "normal")

Calendar.navbarFontSize = "10pt" // Font size (i.e., "10pt" | "14px")
Calendar.headerColor = "#0A246A" // Day of Week heading text color
Calendar.headerBgColor = "#FFFFFF" // Background color
Calendar.headerFontWeight = "bold" // Font weight ("bold" | "normal")

Calendar.headerFontSize = "8pt" // Font size (i.e., "10pt" | "14px")
Calendar.dayFontWeight = "normal" // In-month font weight
Calendar.dayFontSize = "8pt" // Font size (i.e., "10pt" | "14px")

Calendar.paraDayFontWeight = "normal" // Out-of-month font weight
Calendar.paraDayFontSize = "8pt" // Font size (i.e., "10pt" | "14px")
Calendar.todayColor = "orange" // Today's text color
Calendar.todayWeight = "bold" // Today's text color

Calendar.weekdayColor = "black" // Weekday text color
Calendar.weekdayBgColor = "#e2eff5" // Background color
...
Calendar.weekendBgColor = "#ffffff" // Weekend background color

Calendar.paraWeekdayColor = "black" // Out-of-month weekday text color F
Calendar.paraWeekdayBgColor = "#ffffff" // Weekday background color

Calendar.paraWeekendColor = "gray" // Weekend text color
Calendar.paraWeekendBgColor = "#ffffff"// Weekend background color
...
this.gNowDay = Calendar.gNow.getDate()+4;
...
setarrival(vMonth, monthday-1,gCal.gYear);
...
// Weekday style...
this.wwrite( ".today{ " +
"font-weight:" + Calendar.todayWeight + ";" +
"font-size:" + Calendar.dayFontSize + ";" +
"font-family:" + Calendar.fontFace + ";" +
...
vWinCal = window.open( "", "Calendar","width=220,height=220,status=yes,resizable=yes,top=200,left=200" );
...
function calendarShowBirthDate(out_ret) {
/*
p_item	: Name of field to populate for return.
p_month : 0-11 for Jan-Dec; 12 for All Months.
p_year	: 4-digit year.
...
p_month = arguments[1];
if( arguments[2] == "" || arguments[2] == null )
p_year = new String( Calendar.gNow.getYear());
else
p_year = arguments[2];
if( arguments[3] == null )
p_format = "MM/DD/YYYY";
...
*/
//return info
function setarrival(jsmo,jsday,jsyear) {
//alert(global_var);
if (document.forms["afpForm"] && global_var == 1) {
document.forms["afpForm"].outmonth.options.selectedIndex=parseInt(jsmo);
document.forms["afpForm"].outday.options.selectedIndex=parseInt(jsday);
}
else if (document.forms["afpForm"] && global_var == 2) {
document.forms["afpForm"].retmonth.options.selectedIndex=parseInt(jsmo);
document.forms["afpForm"].retday.options.selectedIndex=parseInt(jsday);
}
else if (document.forms["afpForm"] && global_var == 3) {
document.forms["afpForm"].pupmonth.options.selectedIndex=parseInt(jsmo);
document.forms["afpForm"].pupday.options.selectedIndex=parseInt(jsday);
}
else if (document.forms["afpForm"] && global_var == 4) {
document.forms["afpForm"].doffmonth.options.selectedIndex=parseInt(jsmo);
document.forms["afpForm"].doffday.options.selectedIndex=parseInt(jsday);
}
else if (document.forms["afpForm"] && global_var == 5) {

document.forms["afpForm"].cinmonth.options.selectedIndex=parseInt(jsmo);
document.forms["afpForm"].cinday.options.selectedIndex=parseInt(jsday);
}
else if (document.forms["afpForm"] && global_var == 6) {
document.forms["afpForm"].cotmonth.options.selectedIndex=parseInt(jsmo);
document.forms["afpForm"].cotday.options.selectedIndex=parseInt(jsday);
}
else if (document.forms["afpForm"] && global_var == 7) {
document.forms["afpForm"].doa_mm.options.selectedIndex=parseInt(jsmo);
document.forms["afpForm"].doa_dd.options.selectedIndex=parseInt(jsday);
}
else if (document.forms["afpForm"] && global_var == 8) {
document.forms["afpForm"].dod_mm.options.selectedIndex=parseInt(jsmo);
document.forms["afpForm"].dod_dd.options.selectedIndex=parseInt(jsmo);
}
else if (document.forms["qf"] && global_var == 9) {
document.forms["qf"].External_CarSearch_PickupDate.value=parseInt(jsday+1)+"/"+parseInt(jsmo+1)+"/"+jsyear;
}
else if (document.forms["qf"] && global_var == 10) {
document.forms["qf"].External_HotelSearch_CheckInDate.value=parseInt(jsday+1)+"/"+parseInt(jsmo+1)+"/"+jsyear;
}
else if (document.forms["qf"] && global_var == 11) {
document.forms["qf"].External_HotelSearch_CheckOutDate.value=parseInt(jsday+1)+"/"+parseInt(jsmo+1)+"/"+jsyear;
}
else if (document.forms["qf"] && global_var == 12) {
document.forms["qf"].External_FlightFareSearch_DepartureDate.value=parseInt(jsday+1)+"/"+parseInt(jsmo+1)+"/"+jsyear;
}
else if (document.forms["qf"] && global_var == 13) {
document.forms["qf"].External_FlightFareSearch_ReturnDate.value=parseInt(jsday+1)+"/"+parseInt(jsmo+1)+"/"+jsyear;
}
else if (document.forms["qf"] && global_var == 14) {
document.forms["qf"].External_CarSearch_DropOffDate.value=parseInt(jsday+1)+"/"+parseInt(jsmo+1)+"/"+jsyear;
}
else if (document.forms["afpForm"] && global_var == -1) {
document.forms["afpForm"].StartDateTxtBx.value=parseInt(jsday+1)+"/"+parseInt(jsmo+1)+"/"+jsyear;
}
else if ( global_var == 111) {
alert('hi');
alert(document.getElementById('<%=TravelDtTxtBx.ClientID%>').value);
document.forms["holidayform"].TravelDtTxtBx.value=parseInt(jsday+1)+"/"+parseInt(jsmo+1)+"/"+jsyear;
}

/*if (document.afpForm && global_var == 15) {
document.afpForm.Child1MonthDDL.options.selectedIndex=parseInt(jsmo);
document.afpForm.Child1DayDDL.options.selectedIndex=parseInt(jsday);
document.afpForm.Child1YearTxt.value = jsyear;
}
if (document.afpForm && global_var == 16) {
document.afpForm.Child2MonthDDL.options.selectedIndex=parseInt(jsmo);
document.afpForm.Child2DayDDL.options.selectedIndex=parseInt(jsday);
document.afpForm.Child2YearTxt.value = jsyear;
}
if (document.afpForm && global_var == 17) {
document.afpForm.Child3MonthDDL.options.selectedIndex=parseInt(jsmo);
document.afpForm.Child3DayDDL.options.selectedIndex=parseInt(jsday);
document.afpForm.Child3YearTxt.value = jsyear;
}*/
return;
}