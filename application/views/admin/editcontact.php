            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> <?= $contact->user->username; ?>
                            </li>
                        </ol>
                    </div>
                </div>
                  ...
                  <table class="table table-user-information">
                    <tbody>
                        ...
                        <td>
                          <select name="user_id" required>
                            <?php foreach ($users as $user): ?>
                              <?php if ($user->id == $contact->user_id): ?>
                      ...
                      <tr>
                        <td>Department</td>
                        <td>
                          <input type="text" name="department" value="<?= $contact->department; ?>" placeholder="" required>
                        </td>
                      </tr>
                    </tbody>
                  </table>
